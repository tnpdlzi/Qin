...
function roomsOW({ navigation, route }) {
    ...
    const onRefresh = React.useCallback(async() => {
        ...
        setMyRoom(await getDatas(server.ip + '/category/myroom?tier=' + tier + '&game=OW&uID=1'))
            ...
            <View style={styles.container}>
                ...
                <View style={{
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            onPress={() => navigation.navigate('teamOW', {tier: tier})}
                            style={{
                                flexDirection: 'row',
                    ...
                    <TouchableOpacity
                        ...
                        onPress={async () => navigation.navigate('joinedOW', {memtitle: [await getDatas(server.ip + '/category/member?roomID=' + data.roomID + '&game=OW'), await getDatas(server.ip + '/category/title?roomID=' + data.roomID), data.roomID, await getDatas(server.ip + '/category/ismember?roomID=' + data.roomID + '&uID=1')]})}>
                        <View
                            style={{
                                flexDirection: 'row',
                                alignItems: 'center',
