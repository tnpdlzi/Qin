...
let postDatas = async (tier) => await axios.get(server.ip + '/category/getRooms?tier=' + tier + '&game=OW')
  ...
  .catch(function (error) {
      console.log('error : ' + error);
  }).then(async () => await axios.get(server.ip + '/category/roomList?tier=' + tier + '&game=OW')
  .catch(function (error) {
      console.log('error : ' + error);
  })
  .then(function (response) {
...
function roomsOW({ navigation, route }) {
    ...
    const onRefresh = React.useCallback(async() => {
        ...
        setMyRoom(await getDatas(server.ip + '/category/myroom?tier=' + tier + '&game=OW&uID=' + uID))
            ...
            <View style={styles.container}>
                ...
                <View style={{
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            onPress={() => navigation.navigate('teamOW', {tier: tier, uID: uID})}
                            style={{
                                flexDirection: 'row',
                    ...
                    <TouchableOpacity
                        ...
                        onPress={async () => navigation.navigate('joinedOW', {memtitle: [await getDatas(server.ip + '/category/member?roomID=' + data.roomID + '&game=OW'), await getDatas(server.ip + '/category/title?roomID=' + data.roomID), data.roomID, await getDatas(server.ip + '/category/ismember?roomID=' + data.roomID + '&uID=' + uID)], uID: uID})}>
                        <View
                            style={{
                                flexDirection: 'row',
                                alignItems: 'center',
