...
function joinedRS({ navigation, route }) {
    ...
    const onRefresh = React.useCallback(async() => {
        ...
        setMember(await getDatas(server.ip + '/category/member?roomID=' + roomID + '&game=RS'));
            ...
            <ScrollView 
                ...
                <View
                    ...
                    <TouchableOpacity
                        ...
                        onPress={async () => {await getDatas(server.ip + '/category/matched?roomID=' + roomID); await getDatas(server.ip + '/mail/evalMail?roomID=' + roomID + '&game=RS&uID=1'); setIsLeader(false); }}>
