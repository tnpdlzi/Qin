...
function LoginHome({ navigation }) {
    ...
    useEffect (()=>{
        if(logIn){
            changeTextC(require('../../image/login_checked.png'));
        }else{
            changeTextC(require('../../image/login_unchecked.png'))
        }
    }, [logIn]);

    let [textA, changeTextA] = useState(require('../../image/logo_blue.png'));
    function setNewTextA(Text){
        if(Text == ""){
            changeTextA(require('../../image/logo_blue.png'));
        }
        else {
            changeTextA(require('../../image/logo_yellow.png'));
        }
    }
